...
while zeroth == 0:
    ...
    if no == "1":
        ...
        print()  # (passwd,'name,')
        V_SQLInsert = "INSERT INTO usertable (passwrd,username,address,phonenumber,emailid) values (" + str(
            passwd) + ",'" + name + "','" + str(adres) + "','" + str(phno) + "','" + str(email) + "')"
            ...
            while first == 0:
                ...
                if n == "1":
                    while second == 0:
                        ...
                        if fdtype == 7:
                            break
                        list1 = ["Starters", "Seafood", "Tandoori Specials", "Vegetable Dishes", "Side Orders",
                                 "Dessert"]
                        query1 = "select itemno,foodname,price,type from menu where category='" + list1[
                            fdtype - 1] + "'"
                        ...
                        if kya == 1:
                            ...
                            while third == 0:
                                print("do you want to add", noofitem, content2[0], "of rupees", noofitem * content2[1],
                                      "in your cart")
                                yesno = input("enter yes or no = ")

                                if yesno == "yes":
                                    query3 = "insert into bill values('" + str(content2[0]) + "'," + str(
                                        content2[1]) + "," + str(noofitem) + ")"
                                    cur.execute(query3)
                    ...
                    while six == 0:
                        ...
                        for nameuser, passs, addr, phnum, emal in content4:
                            ...
                            query8 = "update usertable set " + list2[
                                inp - 1] + "='" + entry + "' where username ='" + usersname + "'"
                            cur.execute(query8)
                            conn.commit()
